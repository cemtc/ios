...
#import "SKCustomCommonEmptyView.h"

#import "NSString+Size.h"
#import "NSAttributedString+Size.h"

@interface SKCustomCommonEmptyView ()
...
@implementation SKCustomCommonEmptyView
...
- (void)layoutSubviews {
    ...
    if (self.title) {
        CGFloat firstW = SKScreenWidth - 80 * 2;
        CGFloat firstX = (SKScreenWidth - firstW) / 2.0;
...
- (UILabel *)firstL {
    if (!_firstL) {
        ...
        label.textColor = SKDirectionTextColor;
...
- (UILabel *)secondL {
    if (!_secondL) {
        ...
        [self addSubview:label];
        _secondL = label;
        label.font = SKFont(14);
        label.textColor = SKCommonGrayTextColor;
        label.textAlignment = NSTextAlignmentCenter;
        label.numberOfLines = 0;
    }
    return _secondL;
