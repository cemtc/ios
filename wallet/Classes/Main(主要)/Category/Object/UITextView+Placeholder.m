...
//  loanCustomer
//
//  Created by zhangyinglong on 15/8/4.
...
+ (NSDictionary *)defaultPlaceholderAttributes {
    ...
    // 设置颜色
    attributeDic[NSForegroundColorAttributeName] = [UIColor colorWithHexString:@"#63727D"];
...
- (void)drawRect:(CGRect)rect {
    ...
    if ( self.isBeginEditing || self.text.length > 0 ) {
        ...
        [atributedString drawInRect:CGRectMake(self.textContainerInset.left + 10, self.textContainerInset.bottom,
