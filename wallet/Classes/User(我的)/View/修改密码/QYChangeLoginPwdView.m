...
@interface QYChangeLoginPwdView ()
...
@implementation QYChangeLoginPwdView
...
//    self.loginTextField.keyboardType = UIKeyboardTypePhonePad;
    ...
    self.passwordTextField1 = [UITextField textFieldWithPlaceholder:@"请输入新密码" leftIconImage:SKImageNamed(@"icon_password") height:SKAppAdapter(44) leftViewWith:35];
...
//    self.passwordTextField1.keyboardType = UIKeyboardTypePhonePad;
    ...
    self.passwordTextField2 = [UITextField textFieldWithPlaceholder:@"请输入新密码" leftIconImage:SKImageNamed(@"icon_password") height:SKAppAdapter(44) leftViewWith:35];
...
- (void)nextButtonClick:(UIButton *)button {
    ...
    if ([self.delegate respondsToSelector:@selector(qyChangeLoginPwdView:didClickInfo:)]) {
        [self.delegate qyChangeLoginPwdView:self didClickInfo:@{@"name":@"caofuqing"}];
    }
