...
/*
 SKTalkingRefreshAutoNormalFooter *footer = (SKTalkingRefreshAutoNormalFooter *)weakSelf.tableView.mj_footer;
 [footer setTitle:@"" forState:MJRefreshStateIdle];
 */


@interface QYRaiseRecordController ()
//当数据为空的时候 显示您还没数据
@property(nonatomic, strong)  UIView * noDataView;

@end

@implementation QYRaiseRecordController{
...
- (void)loadDataRefreshIndex:(NSInteger)index{
    ...
    SKDefineWeakSelf;
    [CFQCommonServer cfqServerQYAPIgetPlacementRecordListWithInput:input Callback:^(id  _Nonnull response, BOOL success, NSString * _Nonnull message, NSString * _Nonnull code) {
...
- (SKBaseTableViewCell *)sk_cellAtIndexPath:(NSIndexPath *)indexPath {
    ...
    QYRaiseRecordListCell *cell = [QYRaiseRecordListCell cellWithTableView:self.tableView];
