...
@interface QYRedemptionController ()
//当数据为空的时候 显示您还没数据
@property(nonatomic, strong)  UIView * noDataView;

@end

@implementation QYRedemptionController{
...
- (void)loadDataRefreshIndex:(NSInteger)index{
    ...
    SKDefineWeakSelf;
    [CFQCommonServer cfqServerQYAPIgetRansomRecordListByPageWithInput:input Callback:^(id  _Nonnull response, BOOL success, NSString * _Nonnull message, NSString * _Nonnull code) {
...
- (SKBaseTableViewCell *)sk_cellAtIndexPath:(NSIndexPath *)indexPath {
    ...
    QYRedemptionListCell *cell = [QYRedemptionListCell cellWithTableView:self.tableView];
