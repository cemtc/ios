...
class QRReaderVC: UIViewController,AVCaptureMetadataOutputObjectsDelegate {
    ...
    let defautText = NSLocalizedString("扫描", comment: "")
    let errorText = NSLocalizedString("扫描失败", comment: "")
    let successText = NSLocalizedString("扫描成功", comment: "")
    ...
    fileprivate func layoutCloseButton() {
        ...
        closeBtn.setImage(#imageLiteral(resourceName: "icon_back"), for: .normal)
