...
#pragma clang diagnostic pop
                ...
                [_swSelf talkingSearchBarSearchButtonClicked:_swSelf.searchBar];
            }
        };
...
- (void)tagDidCLick:(UITapGestureRecognizer *)gr
{
    ...
    if (1 == label.tag) {
        if ([self.delegate respondsToSelector:@selector(searchViewController:didSelectHotSearchAtIndex:searchText:)]) {
            ...
            [self talkingSearchBarSearchButtonClicked:self.searchBar];
        }
    } else {
...
- (void)talkingSearchBarSearchButtonClicked:(UISearchBar *)searchBar
{
