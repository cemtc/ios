...
//    self.oKButtonTitleColorDisabled = [UIColor colorWithRed:(83/255.0) green:(179/255.0) blue:(17/255.0) alpha:0.5];
    ...
    self.oKButtonTitleColorNormal   = SKThemeColor;
    self.oKButtonTitleColorDisabled = SKThemeColor;
...
//    textAttrs[NSForegroundColorAttributeName] = self.barItemTextColor;
    textAttrs[NSForegroundColorAttributeName] = SKThemeColor;
    ...
    //设置导航字体颜色
    self.navigationBar.titleTextAttributes=@{NSForegroundColorAttributeName:SKThemeColor,NSFontAttributeName:[UIFont boldSystemFontOfSize:19]};
}
